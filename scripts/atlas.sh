...
set -ex
wget https://github.com/hashicorp/atlas-upload-cli/releases/download/v0.2.0/atlas-upload-cli_0.2.0_linux_amd64.tar.gz -O /var/atlas-upload-cli.tar.gz
tar -xzvf /var/atlas-upload-cli.tar.gz
mv /var/atlas-upload-cli_0.2.0_linux_amd64/atlas-upload /usr/local/atlas-upload
